...
{block name="frontend_index_header_css_screen" append}
	<link type="text/css" media="screen, projection" rel="stylesheet" href="{link file='frontend/_resources/css/captcha.css'}" />
{/block}
...
{block name='frontend_index_content'}
    <div class="grid_16 register" id="center">
        ...
        <form method="post" action="{url action=saveRegister}">
            ...
            <div class="payment_method captcha_fieldset">
                <h2 class="headingbox_dark largesize">{$captchaHeadline}</h2>
                <div id="captcha_field">{$captcha}</div>
            </div>
