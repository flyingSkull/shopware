        ...
        {else}
            ...
            {* Pseudo price *}
                <div class='article_details_bottom'>
                    <div {if $sArticle.pseudoprice} class='article_details_price2'>{else}
                        class='article_details_price'>{/if}
...
{* Caching instock status *}
    ...
    {else}
        {if !$sView}
            <input id='price_{$sArticle.ordernumber}' type='hidden'
                   value='{$sArticle.price|replace:".":""|replace:",":"."}'/>
        {/if}
    {/if}
