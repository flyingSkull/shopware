...
return array(
    'title'         => "Shopware 4 - Update Script 4.0.8 zu 4.1",
    'meta_text' => '<strong>Shopware-Update:</strong> 4.0.8 zu 4.1',
    ...
    'migration_counter_text_assignments'  => 'Kategoriebaum wird aktualisiert',
    'migration_counter_text_alsobought'   => 'Datenbestand "Kunden kauften auch" wird aktualisiert',
    'migration_counter_text_topsellers'   => 'Datenbestand "Topseller" wird aktualisiert',
    'migration_counter_text_similarshown' => 'Datenbestand "Ähnliche Artikel" wird aktualisiert',
    ...
    'done_delete' => 'Ihr Shop befindet sich zurzeit im Wartungsmodus.<br/>Bitte löschen Sie den Updater (/update) nun via FTP vom Server.', // The installation was finished successful
