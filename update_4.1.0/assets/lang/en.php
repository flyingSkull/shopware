...
return array(
    'title' => "Shopware 4 - Update Script 4.0.8 to 4.1",
    'meta_text' => '<strong>Shopware-Update:</strong> 4.0.8 to 4.1',
    ...
    'migration_counter_text_assignments'  => 'Update category-tree',
    'migration_counter_text_alsobought'   => 'Update "Customers also bought"',
    'migration_counter_text_topsellers'   => 'Update "Topseller"',
    'migration_counter_text_similarshown' => 'Update "Similar articles"',
    ...
    //<br/><br /> For security reasons, you should now <strong>delete the updater (/update)</strong> from your server via FTP.', // The installation was finished successful

    'done_delete' => 'Your shop is currently in maintenance mode.<br/>Please delete the updater (/update) from your server via FTP.', // The installation was finished successful
